...
function Semester6(props) {
    ...
    let Pharmacology = course1ByGrade * 2
    let intensiveCare = course2ByGrade * 1
    let intensiveCarePhysicalTherapy = course3ByGrade * 3
    let PhysicalTherapyOrganizationandManagement = course4ByGrade * 1
    let gynecologyAndObstetrics = course5ByGrade * 2
    let WomanHealthPhysicalTherapy = course6ByGrade * 6
    let obesityManagement = course7ByGrade * 1
    let electiveCourse1 = course8ByGrade * 2
    let electiveCourse2 = course9ByGrade * 2

    let GPA = (Pharmacology + intensiveCare + intensiveCarePhysicalTherapy + PhysicalTherapyOrganizationandManagement + gynecologyAndObstetrics + WomanHealthPhysicalTherapy + obesityManagement + electiveCourse1 + electiveCourse2) / 20
            ...
            <div className="container mx-auto flex flex-col md:flex-row mt-3 ">
                <div id="course" className=" w-full md:w-2/3 flex flex-col space-y-3 py-3  rounded-lg border border-green-400">
                    ...
                    <div className=" flex flex-row justify-between mx-1 py-2 px-2 bg-green-200 rounded-lg shadow-lg">
                        ...
                        <div className=" text-sm font-bold text-green-950">Pharmacology</div>
                    ...
                    <div className=" flex flex-row justify-between mx-1 py-2 px-2 bg-green-200 rounded-lg shadow-lg">
                        ...
                        <div className=" text-sm font-bold text-green-950">Intensive Care</div>
                    ...
                    <div className=" flex flex-row justify-between mx-1 py-2 px-2 bg-green-200 rounded-lg shadow-lg">
                        ...
                        <div className=" text-sm font-bold text-green-950">Intensive Care Physical Therapy</div>
                    ...
                    <div className=" flex flex-row justify-between mx-1 py-2 px-2 bg-green-200 rounded-lg shadow-lg">
                        ...
                        <div className=" text-sm font-bold text-green-950">PT Organization and Management</div>
                    ...
                    <div className=" flex flex-row justify-between mx-1 py-2 px-2 bg-green-200 rounded-lg shadow-lg">
                        ...
                        <div className=" text-sm font-bold text-green-950">Gynecology and Obstetrics</div>
                    ...
                    <div className=" flex flex-row justify-between mx-1 py-2 px-2 bg-green-200 rounded-lg shadow-lg">
                        ...
                        <div className=" text-sm font-bold text-green-950">Woman Health Physical Therapy</div>
                    ...
                    <div className=" flex flex-row justify-between mx-1 py-2 px-2 bg-green-200 rounded-lg shadow-lg">
                        ...
                        <div className=" text-sm font-bold text-green-950">Obesity Management</div>
                    ...
                    <div className=" flex flex-row justify-between mx-1 py-2 px-2 bg-green-200 rounded-lg shadow-lg">
                        ...
                        <div className=" text-sm font-bold text-green-950">History of Medicine</div>
                    ...
                    <div className=" flex flex-row justify-between mx-1 py-2 px-2 bg-green-200 rounded-lg shadow-lg">
                        ...
                        <div className=" text-sm font-bold text-green-950">Vestibular Rehabilitation</div>
